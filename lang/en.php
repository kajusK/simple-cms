...
$lang = array(
		...
		'EMPTY'			=> "Empty",
		'SERIAL_DELETED'	=> "Item was deleted",
		'SERIAL_DEL_ERR'	=> "Unable to delete item",
		'SERIAL_NO_ITEM'	=> "item doesn't exist",
		'SERIAL_SHORT'		=> "Name too short",
		'SERIAL_LONG'		=> "Name too long",
		...
		'DIR_CREATED'		=> "Dir %s created",
		'DIR_CREATE_FAILED'	=> "Unable to create dir %s",
		'UPLOAD_ERROR'		=> "An error occured during upload",
